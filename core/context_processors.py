from .permissions import can_backup_restore, can_manage_business, can_manage_expenses, can_manage_records, can_view_reports, get_user_role
...
def app_permissions(request):
    ...
    return {
        ...
        'can_manage_expenses': can_manage_expenses(user) if user and user.is_authenticated else False,
